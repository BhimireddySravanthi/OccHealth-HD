   ...
   <example module="orderByExample">
     <file name="index.html">
       ...
       <div ng-controller="ExampleController">
         ...
         <table class="friend">
           <tr>
             <th><a ng-click="predicate = 'name'; reverse=false">Name</a>
                 (<a ng-click="predicate = '-name'; reverse=false">^</a>)</th>
  ...
  <example module="orderByExample">
    <file name="index.html">
      <div ng-controller="ExampleController">
        <table class="friend">
          <tr>
            <th><a ng-click="reverse=false;order('name', false)">Name</a>
              (<a ng-click="order('-name',false)">^</a>)</th>
            <th><a ng-click="reverse=!reverse;order('phone', reverse)">Phone Number</a></th>
            <th><a ng-click="reverse=!reverse;order('age',reverse)">Age</a></th>
          </tr>
 ...
 * `<a ng-click="list.addItem()">Add Item</a>`
 */
 ...
 * in links and their different behaviors:
    <example>
      <file name="index.html">
        ...
        <a id="link-2" ng-click="value = 2">link 2</a> (link, don't reload)<br />
        <a id="link-3" ng-href="/{{'123'}}">link 3</a> (link, reload!)<br />
        <a id="link-4" name="xx" ng-click="value = 4">anchor</a> (link, don't reload)<br />
 ...
 *      [ <a ng-click="settings.greet()">greet</a> ]<br/>
 *      Contact:
 *      <ul>
 ...
 *          [ <a ng-click="settings.clearContact(contact)">clear</a>
 *          | <a ng-click="settings.removeContact(contact)">X</a> ]
 *        </li>
 *        <li>[ <a ng-click="settings.addContact()">add</a> ]</li>
 *     </ul>
 *    </div>
 *   </file>
 *   <file name="app.js">
 ...
 *         </select>
 *         <input type="text" ng-model="contact.value"/>
 *         [ <a ng-click="clearContact(contact)">clear</a>
 *         | <a ng-click="removeContact(contact)">X</a> ]
 *       </li>
 *       <li>[ <a ng-click="addContact()">add</a> ]</li>
 *    </ul>
 *   </div>
 *  </file>
 *  <file name="app.js">
