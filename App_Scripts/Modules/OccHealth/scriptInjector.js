...
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/employeeMedicalProfile.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/encounterDetails.js"></script>';
//files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/employeeDetails.js"></script>';

//encounter types
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/EncounterTypes/encounterTypeCommonCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/EncounterTypes/BLLCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/clinicNotesFormCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/actionItemFormCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Medical-Profile/encounters.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/employeeInformationCtrl.js"></script>';

files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Medical-Profile/appointment.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/EncounterTypes/administerMedicationDetailsCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Medical-Profile/editEmployeeInformation.js"></script>';


files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/EncounterTypes/postOfferPhysicalCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/EncounterTypes/audiometricTestingCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/EncounterTypes/titersCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/EncounterTypes/externalmedicalrecordsCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/EncounterTypes/workSimulationCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/EncounterTypes/biometricsCtrl.js"></script>';

files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/EncounterTypes/audiometricResultsHistoryCtrl.js"></script>';
...
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Directives/Encounter-Details-Dir/schedule-follow-up/schedulefollowup.js"></script>';
...
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/EncounterTypes/ULLCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/EncounterTypes/administerImmunizationCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/EncounterTypes/CommonEncounterTypesCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/EncounterTypes/fitTestingCtrl.js"></script>';

// OCC HEALTH MAIN JS
files = files + ' <script src="/App_Scripts/Bootstrap/js/occ-health.js"></script>';

//ATTACHMENTS
files = files + ' <script src="/App_Scripts/Shared/FileService/attachmentCtrl.js"></script>'
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/EncounterTypes/bloodLeadInvestigationCtrl.js"></script>';

files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/EncounterTypes/drugAlcoholCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/EncounterTypes/spirometryCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Directives/Encounter-Details-Dir/SpirometryDir/SpirometryDetailsDir.js"></script>';

files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/EncounterTypes/vitalsCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/EncounterTypes/healthAnalysisCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Encounters/EncounterTypes/audiometricSTSCtrl.js"></script>';
