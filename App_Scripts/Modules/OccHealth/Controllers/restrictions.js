(function(){
    angular.module("app")
        .controller("restrictionsCtrl", restrictionsCtrl);

    function restrictionsCtrl( $scope, $timeout, $filter, $location, $modal, $log, sharedservices, utilityservices, toastr, $http, globalobject, historySrv ){
        ...
        globalobject.navBar.label = "Restrictions";
        ...
        globalobject.currentPage = "Restrictions";
        ...
        $scope.gotoRestrictions = function (id) {
            $location.path("/restrictions/");
        }

        $scope.gotoRestrictionsDetails = function (id) {
            $location.path("/restrictionsdetails/");
        }
        ...
        //goto RestroctoionsDetails
        // $scope.gotoRestrictions = function (id) {
        //     //send data through factory method
        //     globalobject.currentRestrictions = {'id': id};
        //     $location.path("/restrictionsdetails/");
        // };
        ...
        sharedservices.xhrService(configs)
            .then(function (response) {
                // $scope.picklistEmployees = data.Employees.Object;
                // $log.log(response.data.Employees.Object);
                $scope.findRestrictionsList = response.data.Restrictions.Object; //.EmployeeName
