(function(){
    ...
    function inventoryCtrl( $scope, $timeout, $filter, $location, $modal, $log, sharedservices, utilityservices, toastr, $http, globalobject, historySrv ){
        ...
        globalobject.navBar.label = "Inventory";
        ...
        globalobject.currentPage = "Inventory";
        ...
        $scope.currentMenuItem = $scope.menuItems[1];
        $scope.status = {
            isopen: false
        };
        ...
        $scope.gotoInventoryDetails = function (id) {
            $location.path("/inventorydetails/");
        }
        ...
        $scope.inventoryToggle = function (item) {
		...
		$scope.findPharmacyList = [];
		$scope.findEquipmentList = [];
		$scope.findSupplyList = [];
        ...
        sharedservices.xhrService(configs)
            .then(function (response) {
                // $scope.picklistEmployees = data.Employees.Object;
                // $log.log(response.data.Employees.Object);
                $scope.findPharmacyList = response.data.Pharmacy.Object; //.EmployeeName
                $scope.findEquipmentList = response.data.Equipment.Object; //.EmployeeName
                $scope.findSupplyList = response.data.Supply.Object; //.EmployeeName

            });
            // .then(function (response) {
            //     // $scope.picklistEmployees = data.Employees.Object;
            //     // $log.log(response.data.Employees.Object);
            //     $scope.findEquipmentList = response.data.Inventory.Equipment.Object; //.EmployeeName

            // });
            // .then(function (response) {
            //     // $scope.picklistEmployees = data.Employees.Object;
            //     // $log.log(response.data.Employees.Object);
            //     $scope.findSupplyList = response.data.Inventory.Supply.Object; //.EmployeeName
