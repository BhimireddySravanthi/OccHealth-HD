(function(){
    ...
    function leaveCtrl( $scope, $timeout, $filter, $location, $modal, $log, sharedservices, utilityservices, toastr, $http, globalobject, historySrv ){
        ...
        globalobject.navBar.label = "Leave";
        ...
        globalobject.currentPage = "Leave";
        ...
        sharedservices.xhrService(configs)
            .then(function (response) {
                // $scope.picklistEmployees = data.Employees.Object;
                // $log.log(response.data.Employees.Object);
                $scope.findLeaveList = response.data.Leave.Object; //.EmployeeName
