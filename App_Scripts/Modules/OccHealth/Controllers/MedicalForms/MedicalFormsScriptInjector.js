...
//controllers
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/MedicalForms/MedicalFormsBase.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/MedicalForms/MedicalFormsCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/MedicalForms/EmergencyMedicalFormsCtrl.js"></script>';
