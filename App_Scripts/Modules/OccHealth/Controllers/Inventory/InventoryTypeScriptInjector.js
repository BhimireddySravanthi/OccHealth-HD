...
//controllers
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Inventory/InventoryTypeBase.js"></script>';

//Inventorytypes
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Inventory/medicationCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/Inventory/equipmentCtrl.js"></script>'; 
...
files = files + '<script type="text/javascript" src="/App_Scripts/Modules/OccHealth/Directives/Encounter-Details-Dir/encounter-details-attachments/encounter-details-attachments-dir.js"></script>'
...
//Lookups
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/LookUps/SupplierDetail.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/LookUps/EquipmentType.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/LookUps/EquipmentCategory.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/LookUps/EquipmentModel.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/LookUps/SupplyItemsCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/LookUps/BrandNameCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/LookUps/DrugNameCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/LookUps/ImmunizationTypeCtrl.js"></script>';
files = files + ' <script src="/App_Scripts/Modules/OccHealth/Controllers/LookUps/ManufacturerCtrl.js"></script>';
